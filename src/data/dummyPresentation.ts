...
export const dummyPresentation: Presentation = {
  ...
  slides: [
    ...
    },
    {
      ...
      userParagraph: 'We need the Board to endorse the resource and budget for the Ph2a study, DDI CYP3A4 midazolam study and VEO activities, plus C2Ph2A milestone and Medicine Profile. We seek input on any additional considerations for the team in finalising Phase 2A plans and preparation for the next stage gate (Phase 2B combo). For awareness we are sharing governance boards for this stage gate (ID Board, GSB and access review board) and early views on development and partnership strategy.',
      forDecisionIntro: '',
      forDecision: ['', '', '', '', ''],
      forInputIntro: '',
      forInput: ['', '', '', '', ''],
